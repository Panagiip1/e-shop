...
<html>
<head>
	<title>Διόρθωση Προιόντος</title>
...
<div class="row">
	<div class="col-lg-12">
		<ol class="breadcrumb">
			<li class="active">
				<i class="fas fa-tachometer-alt"></i> Dashboard / Διόρθωση Προιόντος
			</li>
		</ol>
	</div>
</div>
	...
	<div class="col-lg-12">
		<div class="card ">
  			<div class="card-header">
	    		<h4 class="card-title">
	    			<i class="far fa-money-bill-alt"></i> Διόρθωση Προιόντος	
	    		</h4>
	    	</div>
	    		...
	    		<form class="form-horizontal" method="post" enctype="multipart/form-data">
	    			...
	    			<div class="form-group row">
	    				...
	    				<div class="col-md-6">
	    					...
	    					<br><img src="product_images/<?php echo $p_image1; ?>" width="70" height="70" align="left">
	    				</div>
	    			</div>
	    			<div class="form-group row">
	    				...
	    				<div class="col-md-6">
	    					...
	    					<br><img src="product_images/<?php echo $p_image2; ?>" width="70" height="70" align="left">
	    				</div>
	    			</div>
	    			<div class="form-group row">
	    				...
	    				<div class="col-md-6">
	    					...
	    					<br><img src="product_images/<?php echo $p_image3; ?>" width="70" height="70" align="left">
	    				</div>
	    			</div>
	    			<div class="form-group row">
	    			...
	    			<div class="form-group row">
	    				...
	    				<div class="col-md-6">
	    					<input type="submit" name="update" value="Ανανέωση Προιόντος" class="btn btn-primary form-control">
	    				</div>
	    			</div>
...
if($run_product){
	echo "<script>alert('Το Προιόν έχει ανανεωθεί Επιτυχημένα')</script>";
